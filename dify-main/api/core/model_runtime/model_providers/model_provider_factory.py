...
from core.model_runtime.model_providers.n1n_provider import get_n1_provider_entity
...
class ModelProviderFactory:
    ...
    def get_plugin_model_providers(self) -> Sequence[PluginModelProviderEntity]:
        ...
        with contexts.plugin_model_providers_lock.get():
            ...
            # Add local n1n provider
            n1n_provider = get_n1_provider_entity(self.tenant_id)
            if not any(p.declaration.provider == "langgenius/n1n/n1n" for p in plugin_model_providers):
                plugin_model_providers.append(n1n_provider)
